...
function init_gear_sets()
	...
	sets.precast.FC = {sub="Chanter's Shield",ammo="Impatiens",
		head="Merlinic Hood",neck="Orunmila's Torque",ear1="Enchntr. Earring +1",ear2="Loquac. Earring",
		body="Vrikodara Jupon",hands="Volte Gloves",ring1="Kishar Ring",ring2="Lebeche Ring",
	...
	sets.precast.FC.Impact = {ammo="Impatiens",
		head=empty,neck="Orunmila's Torque",ear1="Enchntr. Earring +1",ear2="Malignance Earring",
	...
	sets.midcast.Geomancy = {main="Solstice",sub="Genmei Shield",range="Dunna",
		head="Azimuth Hood +1",neck="Incanter's Torque",ear1="Gifted Earring",ear2="Magnetic Earring",
		body="Bagua Tunic +1",hands="Geo. Mitaines +1",ring1="Stikini Ring +1",ring2="Stikini Ring +1",
		back="Lifestream Cape",waist="Austerity Belt +1",legs="Bagua Pants",feet="Azimuth Gaiters +1"}
    ...
    sets.midcast.Cure = {main=gear.gada_healing_club,sub="Sors Shield",ammo="Hasty Pinion +1",
        head="Vanya Hood",neck="Incanter's Torque",ear1="Mendi. Earring",ear2="Beatific Earring",
        body="Vrikodara Jupon",hands="Telchine Gloves",ring1="Stikini Ring +1",ring2="Stikini Ring +1",
	...
	sets.idle = {main="Bolelabunga",sub="Genmei Shield",range="Dunna",
		...
		body="Bagua tunic +1",hands="Geomancy mitaines +1",ring1="Defending Ring",ring2="Stikini Ring +1",
		back="Solemnity Cape",waist="Fucho-no-obi",legs="Assid. Pants +1",feet="Geo. Sandals +1"}
	...
	sets.idle.Pet = {main="Sucellus",sub="Genmei Shield",range="Dunna",
		...
		body="Jhakri Robe +2",hands="Geo. Mitaines +3",ring1="Defending Ring",ring2="Vocane Ring",
