...
function user_job_setup()
	...
	gear.siphon_staff = {name="Keraunos"}
...
function init_gear_sets()
    ...
    sets.precast.JA['Elemental Siphon'] = {main=gear.siphon_staff,sub="Vox Grip",ammo="Esper Stone +1",
        head="Baayami Hat",neck="Incanter's Torque",ear1="Lodurr Earring",ear2="Andoaa Earring",
        body="Beck. Doublet +1",hands="Lamassu Mitts +1",ring1="Zodiac Ring",ring2="Evoker's Ring",
	...
	--Pact Delay Gear Caps
	--BP Ability Delay1: -15, 2: -15, 3: -10(JP), 4: -10 but -9s with 670smn skill (Favor)
	--Max delay is 30 from 1-3, 40 with favor
	--Baayami Cuffs I -6
	--Baayami Slops I -7
	--Evans Earring I -2
	--Sancus Sachet +1 II -7
	--Glyphic Pigaches +1 II -1
	--Glyphic doublet II -2
	--Total: -25 + JP = -35 = OK

    -- Pact delay reduction gear
    sets.precast.BloodPactWard = {main="Nirvana",sub="Elan Strap +1",ammo="Sancus Sachet +1",
		head="Beckoner's Horn +1",neck="Incanter's Torque",ear1="Lodurr Earring",ear2="Evans Earring",
        body="Glyphic Doublet +1",hands="Baayami Cuffs",ring1="Stikini Ring +1",ring2="Evoker's Ring",
        back="Conveyance Cape",waist="Lucidity Sash",legs="Baayami Slops",feet="Glyph. Pigaches +1"}
    ...
    sets.midcast.Stun.Resistant = {main="Daybreak",sub="Ammurapi Shield",ammo="Hasty Pinion +1",
		head="Amalric Coif +1",neck="Orunmila's Torque",ear1="Enchntr. Earring +1",ear2="Gwati Earring",
		body="Inyanga Jubbah +2",hands="Volte Gloves",ring1="Kishar Ring",ring2="Stikini Ring +1",
    ...
    sets.midcast.Pet.BloodPactWard = {main="Espiritus",sub="Vox Grip",ammo="Sancus Sachet +1",
        head="Beckoner's Horn +1",neck="Incanter's Torque",ear1="Lodurr Earring",ear2="Andoaa Earring",
        body="Beck. Doublet +1",hands="Baayami Cuffs",ring1="Stikini Ring +1",ring2="Evoker's Ring",
    ...
    sets.midcast.Pet.DebuffBloodPactWard = {main="Espiritus",sub="Vox Grip",ammo="Sancus Sachet +1",
        ...
        body="Con. Doublet +2",hands=gear.merlinic_magpact_hands,ring1="C. Palug Rin",ring2="Evoker's Ringg",
    ...
    sets.midcast.Pet.PhysicalBloodPactRage = {main="Nirvana",sub="Elan Strap +1",ammo="Sancus Sachet +1",
        ...
        body="Con. Doublet +2",hands=gear.merlinic_physpact_hands,ring1="Varar Ring +1",ring2="Varar Ring +1",
        back=gear.phys_jse_back,waist="Klouskap Sash",legs="Apogee Slacks +1",feet="Apogee Pumps +1"}
    ...
    sets.midcast.Pet.MagicalBloodPactRage = {main=gear.grioavolr_pet_staff,sub="Elan Strap +1",ammo="Sancus Sachet +1",
        head="Apogee Crown +1",neck="Eidolon Pendant +1",ear1="Gelos Earring",ear2="Esper Earring",
        body="Apogee Dalmatica +1",hands=gear.merlinic_magpact_hands,ring1="Varar Ring +1",ring2="Varar Ring +1",
        back=gear.magic_jse_back,waist="Caller's Sash",legs="Enticer's Pants",feet="Apogee Pumps +1"}

    sets.midcast.Pet.MagicalBloodPactRage.Acc = {head="C. Palug Crown",feet="Convo. Pigaches +3",ear1="Kyrene's Earring"}
	...
	sets.midcast.Pet['Flaming Crush'] = {main="Nirvana",sub="Elan Strap +1",ammo="Sancus Sachet +1",
        head="Apogee Crown +1",neck="Empath Necklace",ear1="Gelos Earring",ear2="Kyrene's Earring",
        body="Apo. Dalmatica +1",hands=gear.merlinic_magpact_hands,ring1="Varar Ring +1",ring2="Varar Ring +1",
        back=gear.phys_jse_back,waist="Klouskap Sash",legs="Apogee Slacks +1",feet="Apogee Pumps +1"}
    ...
    sets.idle.Avatar = {main="Nirvana",sub="Oneiros Grip",ammo="Sancus Sachet +1",
        ...
        body="Shomonjijoe +1",hands="Asteria Mitts +1",ring1="Stikini Ring +1",ring2="Evoker's Ring",
        back="Campestres Cape",waist="Lucidity Sash",legs="Assid. Pants +1",feet="Convo. Pigaches +3"}
    ...
    sets.perp = {main="Nirvana",sub="Oneiros Grip",ammo="Sancus Sachet +1",head="",}
